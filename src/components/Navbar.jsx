...
import { Search, Bookmark, Zap, X, Server, ExternalLink } from 'lucide-react';
...
export default function Navbar({
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-[#070a12]/85 backdrop-blur-2xl border-b border-slate-800/80 shadow-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex-1 max-w-xl relative">
          <div className="relative flex items-center">
            ...
            <input
              type="text"
              placeholder="Search 500+ commands, skills & MCPs (e.g. /goal, bigquery, @codebase)..."
              value={searchQuery}
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-cyan-500/20 via-indigo-500/20 to-purple-500/20 hover:from-cyan-500/30 hover:to-purple-500/30 text-cyan-300 border border-cyan-500/40 text-xs font-semibold shadow-sm transition-all hover:scale-105 active:scale-95"
            title="AI Multi-Platform Bridge for Claude, Antigravity, Codex & Cursor"
          >
            <Server className="w-3.5 h-3.5 text-cyan-400" />
            <span className="hidden md:inline">AI Gateway</span>
          </button>
          ...
          <a
            ...
            title="Support the studio on Buy Me a Coffee"
          >
          ...
          <button
            ...
            title="Sync directly to ~/.cursorrules & ~/.claude/"
          >
